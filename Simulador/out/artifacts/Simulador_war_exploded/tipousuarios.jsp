...
<style>
    body{
        background-image: url(images/TEC.jpe);
        ...
        if(tipousuarios.size() > 0){
            for(int a=0; a<tipousuarios.size();a++){
                htmlcode += "<tr><td>" + tipousuarios.get(a).getIdtipousuario()
                        ...
                        + "<a class=\"btn blue\" href=\"m_tipousuario.jsp?idtipousuario="+tipousuarios.get(a).getIdtipousuario()+"\"><i class=\"material-icons\">create</i></a>"
                        + "<a class=\"btn red\" onclick=\"delete_tipousuario('"+ tipousuarios.get(a).getIdtipousuario()+"')\"><i class=\"material-icons\">delete</i></a>"
                        + "</td></tr>";
            }
            } else{

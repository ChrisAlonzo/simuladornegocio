...
<div class="col s12">
    <header id="header" class="page-topbar">
        <nav class="navbar-color gradient-45deg-cyan-light-green darken-4">
            <div class="nav-wrapper">
                <ul class="right hide-on-med-and-down">
                    <li><a href="index.jsp"><i class="material-icons left">home</i>Inicio</a></li>

                    <li><a href="usuarios.jsp"><i class="material-icons left">person_pin</i>Usuarios</a></li>

                    <li><a href="tipousuarios.jsp"><i class="material-icons left">book</i>Tipo de Usuarios</a></li>

...
<head>
    ...
    <script>
        ...
        {
            var confirmation = confirm(String.fromCharCode(191)+'Est\u00E1 seguro de que desea eliminar el usuario con su ID '+ id_to_delete);
